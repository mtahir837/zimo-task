  ...
  return (
    <>
      <div className="main_div ">
        <nav
          id="nav"
          class=" pt-[20px]  inset-x-0 top-0 flex flex-row justify-between z-10 text-white bg-transparent"
        >
          <div class="p-4  flex justify-between	  ">
            <div class="font-extrabold tracking-widest text-xl pl-[20px]">
            ...
            <div class="  tracking-widest  pt-[30px] pl-[30px] ">
              <p>ABOUT</p>
            </div>
          </div>
          <div>
          ...
          <div class="p-4  flex justify-between	w-[500px] ">
        ...
        >
          <div class=" h-[500px] flex items-center ml-10">
            <div class="">
              <p class="text-gray-100 text-[40px] font-lato">Discover</p>
              <p class="text-gray-200 text-[60px]  ">A NEW WORLD</p>
              <p class="text-[#606060]   text-[20px] font-[Lato] font-[Regular]">
                FOR THOSE WHO WISH FOR MORE...
              </p>
            </div>
          </div>

          <h6 class="text-[#5f5f5f] text-center  text-[20px] font-[Lato] font-[Regular]">
        ...
        <div class="container  mx-auto">
          ...
          <div class="flex flex-wrap -m-4">
            <div class="p-4 lg:w-1/4">
              <div class=" card-div h-screen flex items-center justify-center">
                <card class="relative h-[30rem] sm:h-96 w-[35rem] rounded-lg">
                  <Image src={Group12} alt="" />

                  <div class="absolute w-full h-full bottom-0  rounded-lg flex flex-col items-bottom justify-center text-bottom">
                    <p class=" flex justify-center text-white mt-[120px] tracking-widest">
                      REAL ESTATE
                    </p>
                  </div>
                </card>
            ...
            <div class="p-4 lg:w-1/4">
              <div class="card-div h-screen flex items-center justify-center">
                <card class="relative h-[30rem] sm:h-96 w-[35rem] rounded-lg">
                  ...
                  <div class="absolute w-full h-full bottom-0  rounded-lg flex flex-col items-bottom justify-center text-bottom">
                    <p class=" flex justify-center   text-white mt-[120px] tracking-widest3">
                      WATCHES
                    </p>
                  </div>
                </card>
      ...
      <section class="text-gray-600 body-font">
        ...
        <div class="container flex flex-wrap px-5 py-12 mx-auto items-center">
          <div class="md:w-1/2 md:pr-12 md:py-8 md:border-r md:border-b-0 mb-10 md:mb-0 pb-10 border-b border-gray-200">
            ...
            <p class="text-[40px] mt-[20px] font-[Lato] font-[Regular] text-black ">
              ONE SOURCE
            </p>
            <p class=" text-[60px] font-[Lato] font-[Regular] text-black">
              ENTRY TICKETS
            </p>
            <p class=" text-[20px] font-[Lato] font-[Regular]">
      ...
      <section>
        <div class=" backimage mt-0 h-screen w-full  bg-cover bg-no-repeat">
