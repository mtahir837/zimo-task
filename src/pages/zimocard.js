        ...
        <div className="card-div h-screen flex items-center justify-center">
          <div className="relative rounded-lg">
            ...
            <div className="absolute w-full h-full bottom-0 rounded-lg flex flex-col">
              <div className="days  flex justify-between bg-black bg-opacity-20  rounded-lg ">
                <p className="text-center text-[10px] font-[Lato] font-[Regular] tracking-widest">
                  <span className="text-[40px] mb-0">78</span>
                  <br />
                  DAYS
                </p>
                <p className="text-center text-[10px] font-[Lato] font-[Regular] tracking-widest">
                  <span className="text-[40px] mb-0">28</span>
                  <br />
                  HOURS
                </p>
                <p className="text-center text-[10px] font-[Lato] font-[Regular] tracking-widest">
                  <span className="text-[40px] mb-0">09</span>
                  <br />
                  MINUTES
                </p>
                <p className="text-center text-[10px] font-[Lato] font-[Regular] tracking-widest">
                  <span className="text-[40px] mb-0">08</span>
                  <br />
                  SECONDS
                </p>
              </div>
